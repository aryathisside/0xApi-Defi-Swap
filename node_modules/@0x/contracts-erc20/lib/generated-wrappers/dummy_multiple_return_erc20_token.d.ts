...
export declare type DummyMultipleReturnERC20TokenEventArgs = DummyMultipleReturnERC20TokenApprovalEventArgs | DummyMultipleReturnERC20TokenOwnershipTransferredEventArgs | DummyMultipleReturnERC20TokenTransferEventArgs;
...
export interface DummyMultipleReturnERC20TokenOwnershipTransferredEventArgs extends DecodedLogArgs {
...
export declare class DummyMultipleReturnERC20TokenContract extends BaseContract {
    ...
    }, _name: string, _symbol: string, _decimals: BigNumber, _totalSupply: BigNumber): Promise<DummyMultipleReturnERC20TokenContract>;
    ...
    * @returns True if transfer was successful
    ...
    /**
     * Subscribe to an event type emitted by the DummyMultipleReturnERC20Token contract.
     * @param eventName The DummyMultipleReturnERC20Token contract event you would like to subscribe to.
     ...
     */
    subscribe<ArgsType extends DummyMultipleReturnERC20TokenEventArgs>(eventName: DummyMultipleReturnERC20TokenEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends DummyMultipleReturnERC20TokenEventArgs>(eventName: DummyMultipleReturnERC20TokenEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
