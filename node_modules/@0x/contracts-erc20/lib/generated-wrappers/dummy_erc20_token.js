...
exports.DummyERC20TokenContract = exports.DummyERC20TokenEvents = void 0;
...
(function (DummyERC20TokenEvents) {
    ...
    DummyERC20TokenEvents["OwnershipTransferred"] = "OwnershipTransferred";
...
class DummyERC20TokenContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = DummyERC20TokenContract.deployedBytecode, encoderOverrides) {
        super('DummyERC20Token', DummyERC20TokenContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(DummyERC20TokenContract.ABI(), this._web3Wrapper);
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies, _name, _symbol, _decimals, _totalSupply) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return DummyERC20TokenContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _name, _symbol, _decimals, _totalSupply);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, _name, _symbol, _decimals, _totalSupply) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield DummyERC20TokenContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, _name, _symbol, _decimals, _totalSupply) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contractInstance = new DummyERC20TokenContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield DummyERC20TokenContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = DummyERC20TokenContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    * @returns True if transfer was successful
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, DummyERC20TokenContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, DummyERC20TokenContract.ABI());
            return logs;
        });
    }
}
exports.DummyERC20TokenContract = DummyERC20TokenContract;
DummyERC20TokenContract.contractName = 'DummyERC20Token';
